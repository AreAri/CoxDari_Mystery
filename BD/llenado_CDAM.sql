INSERT INTO Capitulos (nombre, descripcion, icono, orden, id_cap_ant) VALUES
('Introducción', 'Conceptos básicos de estructuras de datos, lo que esconde la mascara de programación', NULL, 1, NULL),
('Apuntadores', 'Todo lo que debes saber del señor Apuntador y sus aliados', NULL, 2, 1),
('Listas Enlazadas', 'Listas simples y doblemente enlazadas... que tan complidado sera?', NULL, 3, 2),


INSERT INTO Niveles (id_cap, tipo, titulo, puntos_recompensa, orden, id_lv_ant) VALUES
(1, 'Teoria', 'Qué son las ED?', 10, 1, NULL),
(1, 'Ejercicio', 'Identificar una ED', 20, 2, 1),
(1, 'Ejercicio', 'Clasifica las ED', 15, 1,2),
(2, 'Teoria', 'Señor apuntador y sus aliados los formatos', 20, 1, NULL),
(2, 'Ejercicio', 'Idetifica los direntes formatos', 15, 2,1),
(2, 'Ejercicio', 'Creando al señor apuntador', 15, 3,2);
